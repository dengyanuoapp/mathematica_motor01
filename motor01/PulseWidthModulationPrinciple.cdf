...
NotebookDataLength[     77476,       1538]
NotebookOptionsPosition[     50242,        952]
NotebookOutlinePosition[     76501,       1513]
CellTagsIndexPosition[     76390,       1507]
WindowTitle->Pulse Width Modulation Principle
WindowFrame->Normal*)
...
Cell["Pulse Width Modulation Principle", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`c$$ = 24, $CellContext`d$$ = 
    0, $CellContext`m$$ = 1, $CellContext`s$$ = True, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`c$$], 24, "relative carrier frequency"}, {12, 24, 
      48}}, {{
       Hold[$CellContext`s$$], True, "show carrier triangle signal"}, {
      True, False}}, {{
       Hold[$CellContext`m$$], 1, "reference magnitude (-60% +20%)"}, 0.4, 
      1.2}, {{
       Hold[$CellContext`d$$], 0, "reference distortion"}, 0, 1}}, 
    Typeset`size$$ = {550., {193., 197.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`c$2334518$$ = 0, $CellContext`s$2334519$$ = 
    False, $CellContext`m$2334520$$ = 0, $CellContext`d$2334521$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`c$$ = 24, $CellContext`d$$ = 
        0, $CellContext`m$$ = 1, $CellContext`s$$ = True}, 
      "ControllerVariables" :> {
        Hold[$CellContext`c$$, $CellContext`c$2334518$$, 0], 
        Hold[$CellContext`s$$, $CellContext`s$2334519$$, False], 
        Hold[$CellContext`m$$, $CellContext`m$2334520$$, 0], 
        Hold[$CellContext`d$$, $CellContext`d$2334521$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Plot[{Sin[$CellContext`x] $CellContext`m$$ + (
           Sin[$CellContext`x 3] (1/3)) $CellContext`d$$, (
          If[$CellContext`x < Pi, 1, -1] If[$CellContext`s$$, 1, 0]) (2.5 
          Abs[Round[($CellContext`c$$/2) ($CellContext`x/
               Pi)] - ($CellContext`c$$/2) ($CellContext`x/Pi)]), 
         If[$CellContext`x < Pi, 
          If[
          Sin[$CellContext`x] $CellContext`m$$ + (
              Sin[$CellContext`x 3] (1/3)) $CellContext`d$$ >= 
           2.5 Abs[Round[($CellContext`c$$/2) ($CellContext`x/
                 Pi)] - ($CellContext`c$$/2) ($CellContext`x/Pi)], 1.25, 0], 
          If[
          Sin[$CellContext`x] $CellContext`m$$ + (
              Sin[$CellContext`x 3] (1/3)) $CellContext`d$$ <= (-2.5) 
            Abs[Round[($CellContext`c$$/2) ($CellContext`x/
                 Pi)] - ($CellContext`c$$/2) ($CellContext`x/Pi)], -1.25, 
           0]]}, {$CellContext`x, 0, 2 Pi}, PlotStyle -> {{
           RGBColor[0.7, 0.9, 0.3], 
           Thickness[0.005]}, {
           RGBColor[0.1, 0.33, 1], 
           Thickness[0.002]}, {
           RGBColor[1, 0.33, 0.1], 
           Thickness[0.002]}}, AxesLabel -> {"time", "voltage"}, PlotPoints -> 
        500, AxesOrigin -> {0, 0}, PlotRange -> {-1.4, 1.4}, PlotLabel -> 
        Style["pulse width modulation", 14], 
        Filling -> {1 -> Axis, 3 -> Axis}, FillingStyle -> Automatic, 
        PerformanceGoal -> "Quality", ImageSize -> {550, 390}], 
      "Specifications" :> {{{$CellContext`c$$, 24, 
          "relative carrier frequency"}, {12, 24, 48}, ControlType -> 
         SetterBar}, {{$CellContext`s$$, True, 
          "show carrier triangle signal"}, {
         True, False}}, {{$CellContext`m$$, 1, 
          "reference magnitude (-60% +20%)"}, 0.4, 1.2, Appearance -> 
         "Labeled"}, {{$CellContext`d$$, 0, "reference distortion"}, 0, 1, 
         Appearance -> "Labeled"}}, 
      "Options" :> {TrackedSymbols :> Manipulate}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{595., {271., 276.}},
...
Cell["\<\
This Demonstration generates a graphical representation of pulse width \
modulation (PWM) used for variable frequency AC motor drives (VFDs). The \
carrier frequency signal is illustrated in blue while the reference signal \
(sine wave) is green.\
\>", "ManipulateCaption"],
...
Cell["\<\
You can change the relative frequency of the carrier signal to observe the \
change in pulse width relative to the reference signal. You can also turn off \
the carrier frequency triangle plot to see the other signals more clearly. In \
addition, you can change the magnitude of the reference signal and add the \
third harmonic distortion.\
\>", "DetailNotes",
 CellID->520480222],

Cell["\<\
The PWM technique can reproduce almost any wave form, not just a sine wave. \
PWM allows a switching device to dissipate relatively low power while it is \
either saturated (full on) or in cut-off.\
\>", "DetailNotes",
 CellID->276732582],

Cell[TextData[{
 "Principles referenced from: D. Hart, ",
 StyleBox["Introduction To Power Electronics",
  FontSlant->"Italic"],
...
Cell[TextData[{
 ButtonBox["Frequency",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Frequency.html"], None}],
 " (",
...
Cell[TextData[{
 ButtonBox["Power",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Power.html"], None}],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
PulseWidthModulationPrinciple&version=0012"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PulseWidthModulationPrinciple/\
PulseWidthModulationPrinciple-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Pulse Width Modulation Principle",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PulseWidthModulationPrinciple/"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PulseWidthModulationPrinciple/"],
 "\"",
 ...
 ButtonBox["http://demonstrations.wolfram.com/PulseWidthModulationPrinciple/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PulseWidthModulationPrinciple/"], 
    None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39385, 681, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39646, 690, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49420, 927, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 76104, 1496},
 {"Copyright", 76299, 1501}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34983, 592, 4113, 80, 70, "Output",
 CellID->169730579],
Cell[39099, 674, 283, 5, 70, "ManipulateCaption"],
Cell[39385, 681, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39646, 690, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41574, 736, 33, 0, 70, "DetailsSection"],
Cell[41610, 738, 391, 7, 70, "DetailNotes",
 CellID->520480222],
Cell[42004, 747, 248, 5, 70, "DetailNotes",
 CellID->276732582],
Cell[42255, 754, 217, 6, 70, "DetailNotes",
 CellID->511468781],
Cell[42475, 762, 44, 0, 70, "RelatedLinksSection"],
Cell[42522, 764, 412, 14, 70, "RelatedLinks",
 CellID->178698557],
Cell[42937, 780, 403, 14, 70, "RelatedLinks",
 CellID->35832816],
Cell[43343, 796, 4826, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[48172, 887, 45, 0, 70, "CitationSection"],
Cell[48220, 889, 858, 24, 70, "Citations"],
Cell[49081, 915, 336, 10, 70, "Author"],
Cell[49420, 927, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature PRqVQu48TmNKnv7UXqeo3Euo *)
